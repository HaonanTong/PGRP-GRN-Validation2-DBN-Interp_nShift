...
for tar_atp in range(2,7):
	db = pd.read_csv('Data/PearsonCorr_C2H4_Interp_Tar_ATP_'+str(tar_atp)+'.csv',index_col = 'id')
	# print db
	...
	fig.savefig('Img/Heatmap_Interp_atp_'+str(tar_atp)+'.pdf',bbox_inches='tight')
	# plt.show()
